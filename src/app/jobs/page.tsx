...
export default function PublicJobsPage() {
    ...
    return (
        ...
        >
            ...
            {/* Call to Action */}
            <Card className="mt-8 bg-instollar-dark text-white">
                <div className="text-center">
                    <h3 className="text-xl font-bold mb-2">Ready to Get Started?</h3>
                    <p className="text-instollar-yellow mb-4">
                        Sign up to get matched with jobs that fit your skills and preferences
                    </p>
                    <div className="flex gap-3 justify-center">
                        <Link href="/register">
                            <Button variant="secondary" className="bg-white text-instollar-dark hover:bg-gray-100">
                                Create Account
                            </Button>
                        </Link>
                        <Link href="/login">
                            <Button variant="secondary" className="border-white text-white hover:bg-white hover:text-instollar-dark">
                                Sign In
                            </Button>
                        </Link>
                    </div>
