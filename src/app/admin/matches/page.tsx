    ...
    const handleCreateMatch = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                alert(errorData.message || 'Failed to create match');
            }
        } catch (err) {
                            ...
                            <form onSubmit={handleCreateMatch}>
                                ...
                                <div className="flex space-x-3">
                                    <button
                                        ...
                                        className="flex-1 bg-instollar-dark text-white py-2 rounded-lg hover:bg-opacity-90 transition-colors disabled:opacity-50"
                                    >
